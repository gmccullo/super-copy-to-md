...
- [ ] **triage-github-issues** — Triage any open items in the GitHub issues tracker — see [[reference_github_issues]].
- [ ] **firefox-port** — Duplicate the extension to be usable in Firefox-style browsers (Firefox, Zen).
